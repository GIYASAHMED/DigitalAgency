...
<>
  ...
  <div
    ...
    className="elementor elementor-76"
  >
    <section
      className="elementor-section elementor-top-section elementor-element elementor-element-cdce8a8 elementor-section-full_width elementor-section-height-default elementor-section-height-default"
      data-id="cdce8a8"
      data-element_type="section"
    >
      <div className="elementor-container elementor-column-gap-no">
        <div
          className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-a3e11c1"
          data-id="a3e11c1"
          data-element_type="column"
        >
          <div className="elementor-widget-wrap elementor-element-populated">
            <div
              className="elementor-element elementor-element-6ed0ca0 elementor-widget elementor-widget-hero-digital"
              data-id="6ed0ca0"
              data-element_type="widget"
              data-widget_type="hero-digital.default"
            >
              <div className="elementor-widget-container">
                <section className="hero__area hero__height fix p-relative d-flex align-items-center">
                  <div className="hero__shape">
                    <img
                      decoding="async"
                      className="hero-shape-1 wow zoomIn"
                      data-wow-delay=".8s"
                      src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/hero/hero-shape-1.png"
                      alt="image"
                    />
                    <img
                      decoding="async"
                      className="hero-shape-2 d-none d-md-block"
                      src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/hero/hero-shape-2.png"
                      alt="image"
                    />
                    <img
                      decoding="async"
                      className="hero-shape-3"
                      src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/hero/hero-shape-3.png"
                      alt="image"
                    />
                    <img
                      decoding="async"
                      className="hero-shape-4 d-none d-sm-block"
                      src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/hero/hero-shape-4.png"
                      alt="image"
                    />
                    <img
                      decoding="async"
                      className="hero-shape-5 d-none d-sm-block"
                      src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/hero/hero-shape-5.png"
                      alt="image"
                    />
                    <img
                      decoding="async"
                      className="hero-shape-6 d-none d-xl-block"
                      src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/hero/hero-shape-6.png"
                      alt="image"
                    />
                    <img
                      decoding="async"
                      className="hero-shape-7 d-none d-sm-block"
                      src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/hero/hero-shape-7.png"
                      alt="image"
                    />
                  </div>
                  <div className="container">
                    <div className="row align-items-center">
                      <div className="col-xxl-6 col-xl-6 col-lg-7 col-md-7 col-sm-10">
                        <div className="hero__content-shape">
                          <img
                            decoding="async"
                            className="hero-c-shape-1 wow zoomIn"
                            data-wow-delay="1.5s"
                            src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/hero/hero-c-shape-1.png"
                            alt="image"
                          />
                        </div>
                        ...
                        <div className="hero__thumb text-end">
                          <div className="hero__thumb-shape">
                            <img
                              ...
                              src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/hero/hero-t-shape-1.png"
                              alt="image"
                            />
                            <img
                              decoding="async"
                              className="hero-t-shape-2"
                              src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/hero/hero-t-shape-2.png"
                              alt="image"
                            />
                            <img
                              decoding="async"
                              className="hero-t-shape-3 wow fadeInRight"
                              data-wow-delay="2s"
                              src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/hero/hero-t-shape-3.png"
                              alt="image"
                            />
                          </div>
                          <div className="hero__thumb-image">
                            <img
                              decoding="async"
                              src="https://thememaster.net/wp/maxdi/wp-content/uploads/2022/07/hero-img.jpg"
                              alt="image"
                            />
                          </div>
                        </div>
    ...
    <section
      className="elementor-section elementor-top-section elementor-element elementor-element-501ead1 elementor-section-full_width elementor-section-height-default elementor-section-height-default"
      data-id="501ead1"
      data-element_type="section"
    >
      <div className="elementor-container elementor-column-gap-no">
        <div
          className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-faa51f4"
          data-id="faa51f4"
          data-element_type="column"
        >
          <div className="elementor-widget-wrap elementor-element-populated">
            <div
              className="elementor-element elementor-element-377bd03 elementor-widget elementor-widget-about"
              data-id="377bd03"
              data-element_type="widget"
                      ...
                      <div className="col-xl-5 offset-xl-1 col-lg-6">
                        ...
                        >
                          <p>
                            ...
                            descended from astronomers rogue. Prime number
                          ...
                          <ul>
                            ...
                            <li>
                              Muse about as a patch of light brain is the seed
                              of intelligence.
                            </li>
                            <li>
    ...
    <section
      className="elementor-section elementor-top-section elementor-element elementor-element-c892741 elementor-section-full_width elementor-section-height-default elementor-section-height-default"
      data-id="c892741"
      data-element_type="section"
    >
      <div className="elementor-container elementor-column-gap-no">
        <div
          className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-025b975"
          data-id="025b975"
          data-element_type="column"
        >
          <div className="elementor-widget-wrap elementor-element-populated">
            <div
              className="elementor-element elementor-element-526fefb elementor-widget elementor-widget-services"
              data-id="526fefb"
              data-element_type="widget"
    ...
    <section
      className="elementor-section elementor-top-section elementor-element elementor-element-663ebfa elementor-section-full_width elementor-section-height-default elementor-section-height-default"
      data-id="663ebfa"
      data-element_type="section"
    >
      <div className="elementor-container elementor-column-gap-no">
        <div
          className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-bb5297e"
          data-id="bb5297e"
          data-element_type="column"
        >
          <div className="elementor-widget-wrap elementor-element-populated">
            <div
              className="elementor-element elementor-element-c22b608 elementor-widget elementor-widget-facts"
              data-id="c22b608"
              data-element_type="widget"
              data-widget_type="facts.default"
            >
              <div className="elementor-widget-container">
                      ...
                      <div className="col-xxl-6 col-xl-5 col-lg-5 col-md-8 col-sm-10">
                        <div className="facts__thumb">
                          <div className="facts__thumb-shape">
                            <img
                              decoding="async"
                              className="facts-s-1 wow zoomIn"
                              data-wow-delay=".6s"
                              src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/facts/facts-s-1.png"
                              alt="image"
                            />
                            <img
                              decoding="async"
                              className="facts-s-2 wow zoomIn"
                              data-wow-delay="1s"
                              src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/facts/facts-s-2.png"
                              alt="image"
                            />
                            <img
                              decoding="async"
                              className="facts-s-3"
                              src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/facts/facts-s-3.png"
                              alt="image"
                            />
                            <img
                              decoding="async"
                              className="facts-s-4 d-none d-md-block"
                              src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/facts/facts-s-4.png"
                              alt="image"
                            />
                          </div>
                          <div className="facts__thumb-image">
                            <img
                              decoding="async"
                              src="https://thememaster.net/wp/maxdi/wp-content/uploads/2022/07/facts-img.png"
                              alt="image"
                            />
                          </div>
                        </div>
                        ...
                        <div className="facts__content">
                          <div className="facts__content-text">
                            ...
                            >
                              ...
                              <span className="second_title">you standout</span>
                            </h2>
                          ...
                          <div className="facts__counter-content d-flex">
                            ...
                            <div className="facts__counter-text">
                              ...
                              <h5>Total Revenue</h5>
                              <p>
                                The carbon in our appies event not nosunrise.
                              </p>
                            </div>
                          </div>
                        </div>
    ...
    <section
      className="elementor-section elementor-top-section elementor-element elementor-element-a200fca elementor-section-full_width elementor-section-height-default elementor-section-height-default"
      data-id="a200fca"
      data-element_type="section"
    >
      <div className="elementor-container elementor-column-gap-no">
        <div
          className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-14ef12b"
          data-id="14ef12b"
          data-element_type="column"
        >
          <div className="elementor-widget-wrap elementor-element-populated">
            <div
              className="elementor-element elementor-element-84743f3 elementor-widget elementor-widget-portfolio"
              data-id="84743f3"
              data-element_type="widget"
              data-settings='{"design_style":"style_1","portfolio_style":"masonry","portfolio_column":"column_4"}'
                ...
                <section className="portfolio__area fix p-relative pb-90">
                  <div className="portfolio__shape">
                    <img
                      ...
                      src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/portfolio/portfolio-s-1.png"
                      alt="img"
                    />
                    <img
                      decoding="async"
                      className="portfolio-s-2"
                      src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/portfolio/portfolio-s-2.png"
                      alt="img"
                    />
                    <img
                      decoding="async"
                      className="portfolio-s-3 d-none d-sm-block"
                      src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/portfolio/portfolio-s-3.png"
                      alt="img"
                    />
                    <img
                      decoding="async"
                      className="portfolio-s-4"
                      src="https://thememaster.net/wp/maxdi/wp-content/themes/maxdi/assets/images/shape/portfolio/portfolio-s-4.png"
                      alt="img"
                    />
                  </div>
                  <div className="container">
                    ...
                    <div className="row grid mt-150">
                      <div className="col-xl-4 col-lg-4 col-md-6 grid-item marketing ui-ux-design">
                        <div
                      ...
                      <div className="col-xl-4 col-lg-4 col-md-6 grid-item development">
                        <div
                          className="portfolio__item mb-30 wow fadeIn"
                          data-wow-delay=".3s"
                        >
                          <div className="portfolio__image">
                            <img
                              decoding="async"
                              src="https://thememaster.net/wp/maxdi/wp-content/uploads/2022/07/portfolio-6.jpg"
                              alt="portfolio"
                            />
                            <div className="portfolio__text">
                              <p>Development</p>
                      ...
                      <div className="col-xl-4 col-lg-4 col-md-6 grid-item branding development">
                        <div
                          className="portfolio__item mb-30 wow fadeIn"
                          data-wow-delay=".3s"
                        >
                      ...
                      <div className="col-xl-4 col-lg-4 col-md-6 grid-item branding marketing">
                        <div
                          className="portfolio__item mb-30 wow fadeIn"
                          data-wow-delay=".3s"
                        >
                          <div className="portfolio__image">
                            <img
                              decoding="async"
                              src="https://thememaster.net/wp/maxdi/wp-content/uploads/2022/07/portfolio-4.jpg"
                              alt="portfolio"
                            />
                            <div className="portfolio__text">
                              <p>Branding, Marketing</p>
                              <h3>
                                <a href="https://thememaster.net/wp/maxdi/ourportfolio/alima-digital/">
                                  Alima Digital
                                </a>
                              </h3>
                              <div className="portfolio__link">
                      ...
                      <div className="col-xl-4 col-lg-4 col-md-6 grid-item branding ui-ux-design">
                        <div
                          className="portfolio__item mb-30 wow fadeIn"
                          data-wow-delay=".3s"
                        >
                          <div className="portfolio__image">
                            <img
                              decoding="async"
                              src="https://thememaster.net/wp/maxdi/wp-content/uploads/2022/07/portfolio-3.jpg"
                              alt="portfolio"
                            />
                            <div className="portfolio__text">
                              <p>Branding, UI/UX Design</p>
                              <h3>
                                <a href="https://thememaster.net/wp/maxdi/ourportfolio/fashion-world/">
                                  Fashion World
                                </a>
                              </h3>
                              <div className="portfolio__link">
    ...
    <section
      className="elementor-section elementor-top-section elementor-element elementor-element-cb67628 elementor-section-full_width elementor-section-height-default elementor-section-height-default"
      data-id="cb67628"
      data-element_type="section"
    >
      <div className="elementor-container elementor-column-gap-no">
        <div
          className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-c3caef1"
          data-id="c3caef1"
          data-element_type="column"
        >
          <div className="elementor-widget-wrap elementor-element-populated">
            <div
              className="elementor-element elementor-element-f709dfc elementor-widget elementor-widget-experience"
              data-id="f709dfc"
              data-element_type="widget"
    ...
    <section
      className="elementor-section elementor-top-section elementor-element elementor-element-176ef92 elementor-section-full_width elementor-section-height-default elementor-section-height-default"
      data-id="176ef92"
      data-element_type="section"
    >
      <div className="elementor-container elementor-column-gap-no">
        <div
          className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-35425bd"
          data-id="35425bd"
          data-element_type="column"
        >
          <div className="elementor-widget-wrap elementor-element-populated">
            <div
              className="elementor-element elementor-element-c4f261f elementor-widget elementor-widget-testimonials"
              data-id="c4f261f"
              data-element_type="widget"
              data-settings='{"testimonial_bg":"yellow_bg"}'
              data-widget_type="testimonials.default"
            >
              <div className="elementor-widget-container">
                <section className="testimonials__area fix p-relative pt-120 pb-120">
                            ...
                            <div className="testimonials__item swiper-slide">
                              <div className="testimonials__item-content">
                                ...
                                <div className="testimonials__text">
                                  <p>
                                    Big data run it up the flag pole core
                                    competencies bench mark. Three martini lunch
                                    we need to dialog around your choice of work
                                    attire data-point. Show pony after I ran
    ...
    <section
      className="elementor-section elementor-top-section elementor-element elementor-element-54f0eb0 elementor-section-full_width elementor-section-height-default elementor-section-height-default"
      data-id="54f0eb0"
      data-element_type="section"
    >
      <div className="elementor-container elementor-column-gap-no">
        <div
          className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-889c67e"
          data-id="889c67e"
          data-element_type="column"
        >
          <div className="elementor-widget-wrap elementor-element-populated">
            <div
              className="elementor-element elementor-element-eb55f92 elementor-widget elementor-widget-faq"
              data-id="eb55f92"
              data-element_type="widget"
    ...
    <section
      className="elementor-section elementor-top-section elementor-element elementor-element-3d92ef6 elementor-section-full_width elementor-section-height-default elementor-section-height-default"
      data-id="3d92ef6"
      data-element_type="section"
    >
      <div className="elementor-container elementor-column-gap-no">
        <div
          className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-303ac4a"
          data-id="303ac4a"
          data-element_type="column"
        >
          <div className="elementor-widget-wrap elementor-element-populated">
            <div
              className="elementor-element elementor-element-ef3003b elementor-widget elementor-widget-blog"
              data-id="ef3003b"
              data-element_type="widget"
                        ...
                        <div className="blog__item mb-40">
                          ...
                          <div className="blog__content">
                            <div className="blog__date d-flex align-items-center justify content-between">
                              <i className="fa-solid fa-clock d-none d-xl-block" />
                              <p>19 Jul, 2022</p>
                              <a
                      ...
                      <div className="col-xl-4 col-lg-4 col-md-6">
                        <div className="blog__item mb-40">
                          ...
                          <div className="blog__content">
                            ...
                            <h3>
                              <a href="https://thememaster.net/wp/maxdi/post-launch-creative-shower-initiative-take-root-over-mart/">
                                Post launch creative shower initiative take root
                                over mart{" "}
                              </a>
                            </h3>
                            <div className="blog__link">
