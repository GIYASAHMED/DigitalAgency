...
<>
              ...
              <nav id="mobile-menu">
                <ul id="menu-main-menu" className="">
                  ...
                  <li
                    ...
                    itemType="https://www.schema.org/SiteNavigationElement"
                    id="menu-item-97"
                    className="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children dropdown active menu-item-97 nav-items"
                  >
                    <a
                      title="Portfolio"
                    ...
                    <ul className="submenu" role="menu">
                      ...
                      <li
                        ...
                        itemType="https://www.schema.org/SiteNavigationElement"
                        id="menu-item-246"
                        className="menu-item menu-item-type-post_type menu-item-object-alimasha-portfolio current-menu-item active menu-item-246 nav-items"
                      >
                        <a
      ...
      <div className="row align-items-center">
        <div className="col-xxl-12">
          <div className="page__title-wrapper">
            <h2 className="page__title-heading">Digital Agency </h2>
            <nav
            ...
            >
              ...
              >
                ...
                >
                  <a
                    href="https://thememaster.net/wp/maxdi/ourportfolio/"
                    itemProp="item"
                  >
  ...
  {/* page-title area end */}
  <section className="portfolio__details p-relative pt-120 pb-100">
      ...
      <div className="row mb-40">
        <div className="col-xl-8 col-lg-8 col-md-8">
          <div className="portfolio__details-thumb">
            <img
              src="https://thememaster.net/wp/maxdi/wp-content/uploads/2022/07/p-d-1.jpg"
              alt="img"
            />
          </div>
        </div>
        <div className="col-xl-4 col-lg-4 col-md-4 d-none d-md-block">
          <div className="portfolio__details-thumb-2">
            <img
              src="https://thememaster.net/wp/maxdi/wp-content/uploads/2022/07/p-d-2.jpg"
              alt="img"
            />
            <img
              src="https://thememaster.net/wp/maxdi/wp-content/uploads/2022/07/p-d-3.jpg"
              alt="img"
            />
          </div>
        </div>
        ...
        <div className="col-xl-7 offset-xl-1 col-lg-7 col-md-7">
          <div className="portfolio__details-content">
            ...
            <div className="values">
              ...
              <div className="values__content">
                <div className="values__content-icon blue" />
                <div className="values__content-text">
              ...
              <div className="values__content">
                <div className="values__content-icon green" />
                <div className="values__content-text">
            ...
            <p>
              ...
              hidden in matter the only home we’ve ever known radio telescope
              decipherment desc.
            </p>
          </div>
        </div>
